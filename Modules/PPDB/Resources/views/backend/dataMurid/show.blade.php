    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2>Form Pendaftaran PPDB SDN 6 Jagaraga Oku</h2>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form action=" {{route('data-murid.update',$murid->id)}} " method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <ul>
                                      <li>Kartu Keluarga
                                        <a href="{{asset('' .$murid->berkas->kartu_keluarga)}}" target="_blank" class="badge badge-info {{$murid->berkas->kartu_keluarga == NULL ? 'hidden' : ''}}">view</a>
                                      </li>
                                      <li>Surat Kelakuan Baik
                                        <a href="{{asset('' .$murid->berkas->surat_kelakuan_baik)}}" target="_blank" class="badge badge-info {{$murid->berkas->surat_kelakuan_baik == NULL ? 'hidden' : ''}} ">view</a>
                                      </li>
                                      <li>Surat Tidak Buta Warna
                                        <a href="{{asset('' .$murid->berkas->surat_tidak_buta_warna)}}" target="_blank" class="badge badge-info {{$murid->berkas->surat_tidak_buta_warna == NULL ? 'hidden' : ''}} ">view</a>
                                      </li>
                                      <li>ijazah
                                        <a href="{{asset('' .$murid->berkas->ijazah)}}" target="_blank" class="badge badge-info {{$murid->berkas->ijazah == NULL ? 'hidden' : ''}} ">view</a>
                                      </li>
                                    </ul>
                                </div>
                                <div class="col-6">
                                  <ul>
                                    <li>Akte Kelahiran
                                      <a href="{{asset('' .$murid->berkas->akte_kelahiran)}}" target="_blank" class="badge badge-info {{$murid->berkas->akte_kelahiran == NULL ? 'hidden' : ''}} ">view</a>
                                    </li>
                                    <li>Surat Sehat
                                      <a href="{{asset('' .$murid->berkas->surat_sehat)}}" target="_blank" class="badge badge-info {{$murid->berkas->surat_sehat == NULL ? 'hidden' : ''}} ">view</a>
                                    </li>
                                    <li>Rapor
                                      <a href="{{asset('' .$murid->berkas->rapor)}}" target="_blank" class="badge badge-info {{$murid->berkas->rapor == NULL ? 'hidden' : ''}} ">view</a>
                                    </li>
                                  </ul>
