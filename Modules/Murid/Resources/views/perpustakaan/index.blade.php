                        ...
                        <div class="row">
                          @foreach ($book as $books)
                            <div class="col-md-6 col-12">
                                <div class="card">
                                    <a href="#">
                                        <img class="card-img-top img-fluid" src="{{asset('' .$books->thumbnail)}}" alt="Cover Buku" style="max-height: 200px; max-weidth:100px; min-height:200px" />
                                    </a>
                                    <div class="card-body">
                                        <h4 class="card-title">
                                ...
                                @foreach ($populer as $populers)
                                  <div class="media mb-2">
                                    <a href="page-blog-detail.html" class="mr-2">
                                        <img class="rounded" src="{{asset('' .$populers->thumbnail)}}" width="100" height="70" alt="Recent Post Pic" />
                                    </a>
                                    <div class="media-body">
