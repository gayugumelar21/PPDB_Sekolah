...
<head>
    ...
    <meta name="description" content="SDN 6 Jagaraga Oku adalah aplikasi manajemen sekolah berbasis website yang di bangun dan di kembangkan dengan Framework Laravel">
    <meta name="keywords" content="">
    <meta name="author" content="SDN 6 Jagaraga Oku">
    <title>Register Page - SDN 6 Jagaraga Oku</title>
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
    <div class="custom-alert" id="customAlert">
            <div class="alert-header">Peringatan</div>
            <p>Maaf, Umur Calon Siswa Dibawah 7 Tahun.</p>
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="/">
                            ...
                            <h2 class="brand-text text-primary ml-1">SDN 6 Jagaraga Oku</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                @endif
                                <h2 class="card-title font-weight-bold mb-1">Welcome to SDN 6 Jagaraga Oku! 👋</h2>
                                <p class="card-text mb-2">Pendaftaran PPDB SDN 6 Jagaraga Oku</p>
                                <form class="auth-login-form mt-2" action="{{route('register.store')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('tanggal_lahir') is-invalid @enderror" type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" placeholder="Masukan Tanggal Lahir" autofocus="" tabindex="1" />
                                        @error('tanggal_lahir')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group" style="display: none;">
                                        <label class="form-label">Asal Sekolah</label>
                                        <input class="form-control @error('asal_sekolah') is-invalid @enderror" type="hidden" name="asal_sekolah" value="test" placeholder="Masukan Asal Sekolah" autofocus="" tabindex="1" />
                                        @error('asal_sekolah')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
...
<script>
        document.querySelector('form').addEventListener('submit', function(e) {
            var birthDate = new Date(document.querySelector('input[name="tanggal_lahir"]').value);
            var today = new Date();
