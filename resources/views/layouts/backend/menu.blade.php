<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <!-- KERJAAN - MENU TAMBAHAN -->
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="#"><i data-feather="database"></i>
                    <span class="menu-title text-truncate" data-i18n="Data Sekolah">Kelola Berkas</span>
                </a>
                <ul class="menu-content">

                    <li class="nav-item {{ (request()->is('backend-cekandvalidasi')) ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href=" {{route('backend-cekandvalidasi.index')}} "><i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Basic">Cek & Validasi Data</span>
                        </a>
                    </li>
            ...
            @elseif(Auth::user()->role == 'Murid')
              <li class="nav-item {{ (request()->is('murid/persyaratan')) ? 'active' : '' }}">
                <a class="d-flex align-items-center" href=" {{route('inputsyarat.create')}} "><i data-feather="book"></i>
                    <span class="menu-title text-truncate" data-i18n="Books">Input Persyaratan</span>
                </a>
              </li>
              <!-- <li class="nav-item {{ (request()->is('murid/perpustakaan')) ? 'active' : '' }}">
                <a class="d-flex align-items-center" href=" {{route('perpustakaan.index')}} "><i data-feather="book"></i>
                    <span class="menu-title text-truncate" data-i18n="Books">Input Perpus</span>
                </a>
              </li> -->
