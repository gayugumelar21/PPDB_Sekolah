            ...
            @if (Auth::user()->role == 'Admin')
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <h2 class="font-weight-bolder mb-0">{{$muridDitolak}}</h2>
                                    <p class="card-text">Siswa Ditolak</p>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div>
                                <h2 class="font-weight-bolder mb-0">{{$muridDiproses}}</h2>
                                <p class="card-text">Proses Validasi</p>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <h2 class="font-weight-bolder mb-0">{{$muridDiterima}}</h2>
                                    <p class="card-text">Siswa Diterima</p>
                                </div>
