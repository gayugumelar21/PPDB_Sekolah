                    ...
                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                        <div class="event-details-inner">
                            <div class="event-details-img">
                                ...
                                <a href="#"><img src="{{asset('' .$event->thumbnail)}}" alt="event" class="img-responsive"></a>
                            </div>
                                            ...
                                            @foreach ($eventOther as $events)
                                                <li>
                                                    <div class="latest-research-img">
                                                        <a href="{{route('detail.event', $events->slug)}}"><img src="{{asset('' .$events->thumbnail)}}" class="img-responsive" alt="skilled"></a>
                                                    </div>
                                    ...
                                    <div class="sidebar-latest-research-area">
                                        <ul>
                                            @foreach ($berita as $beritas)
                                                <li>
                                                    <div class="latest-research-img">
                                                        <a href="{{route('detail.berita', $beritas->slug)}}"><img src="{{asset('' .$beritas->thumbnail)}}" class="img-responsive" alt="skilled"></a>
                                                    </div>
                                                    <div class="latest-research-content">
