...
//     return "Halaman coba Input syarat";
// });
Route::get('halaman-coba',[App\Http\Controllers\Backend\Pengguna\CobaController::class,'index'])->name('coba.index');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('/')->middleware('role:Admin')->group( function (){
        ...
        Route::resources([
            ...
            // KERJAAN - CEK DAN VALIDASI DATA
            'backend-cekandvalidasi'    => Backend\Website\CekValidasiDataController::class,
        ]);
        ...
        Route::resources([
            ...
            'backend-pengguna-murid-cekdata' => Backend\Website\CekValidasiDataController::class,
            'backend-pengguna-murid-status' => Backend\Website\CekValidasiDataController::class,
    ...
    Route::prefix('/')->middleware('role:Murid')->group( function (){
        ...
        Route::resources([   
            // KERJAAN
            'inputsyarat' => Backend\Pengguna\InputSyaratController::class,
            'inputsyarat-buat' => Backend\Pengguna\InputSyaratController::class,
